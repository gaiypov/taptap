-- ИСПРАВЛЕННЫЙ SQL СКРИПТ - С ПРАВИЛЬНОЙ СТРУКТУРОЙ
-- Выполните этот SQL в Supabase SQL Editor

-- 1. УДАЛЯЕМ СУЩЕСТВУЮЩУЮ ТАБЛИЦУ LISTINGS (если есть)
DROP TABLE IF EXISTS public.listings CASCADE;

-- 2. СОЗДАЕМ ТАБЛИЦУ LISTINGS С ПРАВИЛЬНОЙ СТРУКТУРОЙ
...
-- 3. СОЗДАЕМ ТАБЛИЦУ USERS (если не существует)
...
-- 13. ДОБАВЛЯЕМ ТЕСТОВЫЕ ДАННЫЕ (ТОЛЬКО СУЩЕСТВУЮЩИЕ ПОЛЯ)
