 ...
 * 
 * Dependencies:
 * expo-image-picker, expo-av, react-native-reanimated
 */
...
export default function PhotoToVideoScreen({ navigation, route }) {
                ...
                {DURATION_OPTIONS.map(option => (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setSettings(prev => ({
                        ...prev,
                        duration_per_photo: option.value,
                ...
                {TRANSITION_OPTIONS.map(option => (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setSettings(prev => ({
                        ...prev,
                        transition: option.value as any,
                      }));
                    }}
                  >
